...
def run_bioscan5m(data_dir, out_dir):
    ...
    make_sunburst(ref_df, LEVELS, os.path.join(out_dir, "taxdist_bioscan5m_reference.png"),
                  color_rank, cat_color)
    make_sunburst(query_df, LEVELS, os.path.join(out_dir, "taxdist_bioscan5m_query.png"),
                  color_rank, cat_color)
...
def run_its5m(data_dir, out_dir, query_fasta, query_name):
    ...
    make_sunburst(taxonomy_columns(train_df), LEVELS,
                  os.path.join(out_dir, "taxdist_its5m_reference.png"),
                  color_rank, cat_color)
