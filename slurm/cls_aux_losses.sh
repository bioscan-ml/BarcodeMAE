#!/bin/bash
#SBATCH --job-name=barcodeMAE_cls_aux
...
# task 0 = triplet   (batch-hard triplet, margin=0.3)
# task 1 = supcon    (supervised contrastive, temperature=0.07)
# task 2 = ce        (cross-entropy classification head)
