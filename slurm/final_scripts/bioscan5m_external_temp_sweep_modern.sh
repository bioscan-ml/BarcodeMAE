#!/bin/bash
# ============================================================================
# BIOSCAN-5M external baselines: softmax-KNN temperature sweep, for the 3
# models that need the modern venv (newer transformers/torch/mamba_ssm) --
# HyenaDNA-tiny, Caduceus-PS-1k, GENA-LM. See bioscan5m_external_temp_sweep.sh
# for the other 4 (main-venv) models.
#
# REQUIRES slurm/setup_env_modern.sh to have been run once first.
#
# Submit: sbatch slurm/final_scripts/bioscan5m_external_temp_sweep_modern.sh
# ============================================================================
#SBATCH --job-name=bioscan5m_external_temp_sweep_modern
